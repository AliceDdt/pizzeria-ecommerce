 ...
 */
final class Version20220412084308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE detail_order (id INT AUTO_INCREMENT NOT NULL, pizza_detail_id INT NOT NULL, ordering_id INT NOT NULL, quantity INT NOT NULL, total_price DOUBLE PRECISION NOT NULL, INDEX IDX_88D958C15A4E593D (pizza_detail_id), INDEX IDX_88D958C18E6C7DE4 (ordering_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE detail_order ADD CONSTRAINT FK_88D958C18E6C7DE4 FOREIGN KEY (ordering_id) REFERENCES `order` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detail_order DROP FOREIGN KEY FK_88D958C18E6C7DE4');
